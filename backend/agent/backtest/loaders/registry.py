...
def _ensure_registered() -> None:
    ...
    _loader_modules = [
        ...
        "backtest.loaders.funding_rate_loader",
        "backtest.loaders.bybit_loader",
        "backtest.loaders.gate_loader",
...
FALLBACK_CHAINS: dict[str, list[str]] = {
    ...
    "crypto":    ["okx", "binance", "bybit", "gate", "ccxt", "yfinance", "local"],
    "futures":   ["binance", "akshare", "local"],
    "fund":      ["cmc", "akshare", "local"],
    "macro":     ["akshare", "binance", "local"],
